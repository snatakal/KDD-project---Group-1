...
This project is being completed as part of the Knowledge Discovery in Databases (ITCS - 6162) course at The University of North Carolina at Charlotte.
...
## Introduction
League of Legends, commonly referred to as League, is a highly popular Multiplayer online battle arena game by RIOT Games. If this is your first time hearing about League, this [page](https://www.leagueoflegends.com/en-us/how-to-play/) by RIOT Games provides a quick introduction to the game.

League is currently one of the most played and most viewed games on Twitch, a popular streaming platform. The League of Legends World Championship held annually is one of the largest esports in the world, with a prize pool of more than 2 million USD. The game attracts many players and viewers from different regions of the world, with the largest player bases being Europe and North America. 

Being such a popular game, streamers, professional teams, and team sponsors have high stakes riding on their performance in the game. As such a lot of time and resources are spent analysing the game with the goal of maximizing a teams’ win rate. 
...
This project will consider several of these attributes in conjunction with the team-composition of the two teams (the champions that each team consists of) and identify the factors that are most useful in predicting the outcome of the match.
...
As outlined in the Introduction, for those with high stakes in League, constantly improving their game win rate is an important matter. Being able to determine the chances of winning a match based on the team composition is very valuable to players, as it will help them choose the best possible champion for each match.
...
### Data Understanding
#### Data Collection
The initial dataset ‘matches.csv’ was obtained as described in the [Data](#data) section. The dataset had fourteen columns and 1312252 records.
